 ...
 *{
 ...
 <body>
     ...
     <div class='body'>
         <h1>Notification </h1>
         <p>L'utilisateur <strong>{{$order_admin_Info['name']}}</strong> a effectué une commande.</p>
           <P>les informations concernant l'achat sont ci dessous:</P>
         <div class='contact' style='margin-top: 18px;'>
             <p>Nom client : <span>{{$order_admin_Info['name']}}</span></p>
             <p>Ordre d'achat : <span>{{$order_admin_Info['order_id']}}</span></p>
             <p>Numero d'achat : <span>{{$order_admin_Info['invoice_no']}}</span></p>
             <p>Methode de Paiement: <span>Stripe</span></p>
             <p>Somme total : <span>{{$order_admin_Info['amount']}} <strong>FCFA</strong></span></p>
         </div>
         <p>Veuiller consulter la page admin pour plus d'informations <a href="" style="color: teal;"><strong>Consulter</strong></a>.</p>
