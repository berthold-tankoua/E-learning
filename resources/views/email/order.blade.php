 ...
 *{
 ...
 <body>
     ...
     <div class='body'>
         <h1>Cher {{$OrderInfo['name']}}</h1>
         <p>Votre Commande s'est deroulé avec succes vous serez livrez d'ici 1 à 10 jours .</p>
           <P>les informations concernant votre achat sont ci dessous:</P>
         <div class='contact' style='margin-top: 18px;'>
             <p>Numero d'achat : <span>{{$OrderInfo['invoice_no']}}</span></p>
             <p>Methode de Paiement: <span>{{$OrderInfo['payment_method']}}</span></p>
             <p>Somme total : <span>{{$OrderInfo['amount']}} <strong>FCFA</strong></span></p>
         </div>
