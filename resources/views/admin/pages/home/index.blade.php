...
@section('title')
School Managment - Dashboard
@endsection

@php
 $courses = App\Models\Product::get();
 $lessons = App\Models\Lesson::get();
 $orders = App\Models\Order::get();
 $visits = App\Models\VisitCount::get();
 $count=0;
            ...
            <div class="col-xl-3 col-6">
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        ...
                        <div>
                            <p class="text-mute mt-20 mb-0 font-size-16">Course(s)</p>
                            <h3 class="text-white mb-0 font-weight-500">{{ count($courses) }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        <div class="icon bg-warning-light rounded w-60 h-60">
                            <i class="text-warning mr-0 font-size-24 mdi  mdi-play"></i>
                        </div>
                        <div>
                            <p class="text-mute mt-20 mb-0 font-size-16">Lesson(s)</p>
                            <h3 class="text-white mb-0 font-weight-500">{{ count($lessons) }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-6">
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        ...
                        <div>
                            <p class="text-mute mt-20 mb-0 font-size-16">Visit(s) </p>
                            <h3 class="text-white mb-0 font-weight-500">{{ $count }} </h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        <div class="icon bg-danger-light rounded w-60 h-60">
                            <i class="text-danger mr-0 font-size-24 mdi mdi-cart-plus"></i>
                        </div>
                        <div>
                            <p class="text-mute mt-20 mb-0 font-size-16">Command(s)</p>
