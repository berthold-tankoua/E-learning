    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-header with-border">
                <h4 class="box-title">Editer l'utilisateur | {{ $item->firstname }} </h4>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col">
                        <form action="{{ route('users.updates') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row"> <!-- start 1st row  -->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="old_img" value="{{ $item->profil_pic }}">
                                                <h5>Nom <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <input type="text" name="firstname" class="form-control" placeholder="Entrer le nom" value="{{ $item->firstname }}">
                                                    @error('firstname') 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="lastname" class="form-control" placeholder="Entrer le prenom" value="{{ $item->lastname }}">
                                                    @error('lastname') 
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="row"> <!-- start 6th row  -->
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    @enderror
                                                    <br>
                                                    <img src="{{ asset($item->profil_pic) }}" id="mainThmb" width="100px" height="100px">
                                                </div>
                                            </div>
                                        </div> <!-- end col md 4 -->
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="user_role" class="form-control" placeholder="Ex: professeur, parent, gardien" value="{{$item->user_role}}">
                                                    @error('user_role') 
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
