                ...
                <div class="box box-bordered border-primary">
                  ...
                  <table class="table">
                              ...
                              <th style="text-align: center;"> 
                                  ...
                                  <a href="{{ route('pending-confirm',$order->id) }}" class="btn btn-block btn-success text-center"  id="confirm">Livraison Effectué</a>
                ...
                <div class="box box-bordered border-primary">
                  ...
                  <table class="table">
                        ...
                        <tr>
                          ...
                          <td width="10%">
                                    <label for=""> {{ $item->price }} FCFA </label>
                                  </td>
