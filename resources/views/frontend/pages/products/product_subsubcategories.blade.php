...
@php
    foreach($products as $item){
        $sub_sub_title = $item->subsubcategory->subsubcategory_name_fr;
        
        $category_id = $item->category_id;
        $category_title = $item->category->category_name_fr;
        $category_slug = $item->category->category_slug_fr;

        $sub_category_id = $item->subcategory_id;
        $sub_title = $item->subcategory->subcategory_name_fr;
        $sub_category_slug = $item->subcategory->subcategory_slug_fr;
    }
@endphp

@section('title')
E-learning | {{$sub_sub_title}}
@endsection
  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        ...
        <li >{{$sub_title}}</li>
        <li class='active'>{{$sub_sub_title}}</li>
      </ul>
    </div>
    <!-- /.breadcrumb-inner --> 
  </div>
